...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "skQHBfnnpYhOBpROLUFHLjaxi", consumerSecret: "Tl7u1HVYHFplH4WOgXQVmoLuCUkLimU0EIVjKe9Qdam7F31MVX")
    var loginSuccess: (() -> ())?
